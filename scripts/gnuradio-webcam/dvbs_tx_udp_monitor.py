...
# Title: Dvbs Tx Udp Monitor
# Generated: Tue Mar 19 17:37:51 2019
##################################################
...
class dvbs_tx_udp_monitor(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Dvbs Tx Udp Monitor")
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, '127.0.0.1', 57000, 1472, False)
        ...
        self.connect((self.blocks_udp_source_0, 0), (self.blocks_udp_sink_0, 0))    
...
def main(top_block_cls=dvbs_tx_udp_monitor, options=None):
