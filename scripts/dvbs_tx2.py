...
# Title: Dvbs Tx2
# Generated: Tue Nov 20 17:59:39 2018
##################################################
...
class dvbs_tx2(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Dvbs Tx2")
        ...
        self.pluto_sink_0 = iio.pluto_sink('', int(frequency), int(samp_rate), int(20000000), 0x8000, False, 0.0, '', True)
        ...
        dtv.C8_9, dtv.MOD_QPSK, dtv.INTERPOLATION_ON)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(2)
        self.blocks_packed_to_unpacked_xx_0 = blocks.packed_to_unpacked_bb(1, gr.GR_MSB_FIRST)
        self.blocks_pack_k_bits_bb_0 = blocks.pack_k_bits_bb(2)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "/media/" + username + "/PlutoSDR/MPEG2-lalinea.ts", False)
    ...
    def set_username(self, username):
        ...
        self.blocks_file_source_0.open("/media/" + self.username + "/PlutoSDR/MPEG2-lalinea.ts", False)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.pluto_sink_0.set_params(int(self.frequency), int(self.samp_rate), int(20000000), 0.0, '', True)
...
def main(top_block_cls=dvbs_tx2, options=None):
